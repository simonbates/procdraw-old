...
*** INPROGRESS Implement a PrettyPrinter
...
*** TODO Update text layout to support newlines
*** TODO Remove previous, non-pretty, printer

If in the future I need non-pretty printing, I can incorporate it into
the new printer.
