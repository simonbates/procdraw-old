...
** TODO Implement a Dictionary type
*** TODO Make strings immutable
*** TODO Implement C++ == operator for LispObjectPtr

    And use it for the implementation of (eq).
...
*** TODO Implement C++ hash for LispObjectPtr
