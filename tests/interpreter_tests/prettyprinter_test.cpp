...
protected:
    virtual void SetUp() {
        ...
        lambdaWithParams_ = L_.Read("(lambda (param1 param2) (call1) (call2 arg1 arg2 arg3))");
        lambdaLongParamList_ = L_.Read("(lambda (param1 param2 param3 param4) (call1) (call2 arg1 arg2 arg3))");
    }
...
TEST_F(PrettyPrinterTest, PrintLambdaAllOneLine)
{
    ...
    EXPECT_EQ("(lambda (param1 param2 param3 param4) (call1) (call2 arg1 arg2 arg3))",
...
{
    std::string expectedNoParams =
        "(lambda nil\n"
        "  (call1)\n"
        "  (call2 arg1 arg2 arg3))";

    EXPECT_EQ(expectedNoParams, prettyPrinter_.PrintToString(&L_, lambdaNoParams_, 25));

    std::string expectedWithParams =
        "(lambda (param1 param2)\n"
        "  (call1)\n"
        "  (call2 arg1 arg2 arg3))";

    EXPECT_EQ(expectedWithParams, prettyPrinter_.PrintToString(&L_, lambdaWithParams_, 25));
    ...
    EXPECT_EQ(expectedLongParamList, prettyPrinter_.PrintToString(&L_, lambdaLongParamList_, 37));
}
...
TEST_F(PrettyPrinterTest, PrintLambdaBreakLongParamList)
{
    ...
    EXPECT_EQ(expected, prettyPrinter_.PrintToString(&L_, lambdaLongParamList_, 36));
}
...
TEST_F(PrettyPrinterTest, PrintLambdaBreaksEverywhere)
{
    ...
    EXPECT_EQ(expected, prettyPrinter_.PrintToString(&L_, lambdaLongParamList_, 24));
}

TEST_F(PrettyPrinterTest, PrintIncompleteLambda)
{
    EXPECT_EQ("(lambda)", prettyPrinter_.PrintToString(&L_, L_.Read("(lambda)"), 100));
    EXPECT_EQ("(lambda nil)", prettyPrinter_.PrintToString(&L_, L_.Read("(lambda ())"), 100));
    EXPECT_EQ("(lambda nil nil)", prettyPrinter_.PrintToString(&L_, L_.Read("(lambda () nil)"), 100));
}
