...
protected:
    ...
    static void ExpectGlyphVertices(const procdraw::GlyphCoords &expected,
        ...
        // Left top
        EXPECT_EQ(expectedHOffset + expected.Left,   vertices[verticesOffset + 0]);
        ...
        // Left bottom
        EXPECT_EQ(expectedHOffset + expected.Left,   vertices[verticesOffset + 4]);
        EXPECT_EQ(expectedVOffset + expected.Bottom, vertices[verticesOffset + 5]);
        EXPECT_EQ(expected.TextureLeft,              vertices[verticesOffset + 6]);
        EXPECT_EQ(expected.TextureBottom,            vertices[verticesOffset + 7]);

        // Right top
        EXPECT_EQ(expectedHOffset + expected.Right,  vertices[verticesOffset + 8]);
        ...
        // Left bottom
        EXPECT_EQ(expectedHOffset + expected.Left,   vertices[verticesOffset + 12]);
        EXPECT_EQ(expectedVOffset + expected.Bottom, vertices[verticesOffset + 13]);
        EXPECT_EQ(expected.TextureLeft,              vertices[verticesOffset + 14]);
        EXPECT_EQ(expected.TextureBottom,            vertices[verticesOffset + 15]);

        // Right bottom
        EXPECT_EQ(expectedHOffset + expected.Right,  vertices[verticesOffset + 16]);
        EXPECT_EQ(expectedVOffset + expected.Bottom, vertices[verticesOffset + 17]);
        EXPECT_EQ(expected.TextureRight,             vertices[verticesOffset + 18]);
        EXPECT_EQ(expected.TextureBottom,            vertices[verticesOffset + 19]);

        // Right top
        EXPECT_EQ(expectedHOffset + expected.Right,  vertices[verticesOffset + 20]);
        EXPECT_EQ(expectedVOffset + expected.Top,    vertices[verticesOffset + 21]);
...
TEST_F(FontUtilsTest, TextLayoutEmptyStringHasOneEmptyLine)
{
...
TEST_F(FontUtilsTest, TextLayoutSingleLine)
{
...
TEST_F(FontUtilsTest, TextLayoutEmbeddedNewline)
{
    auto layout = procdraw::LayOutText<float>("!\n !!", fontMetrics_, 100, 1000);
