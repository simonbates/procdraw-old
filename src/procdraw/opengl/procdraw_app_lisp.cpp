#include "procdraw/opengl/procdraw_app_lisp.h"
#include "procdraw/core/interpreter/signals.h"

namespace procdraw {

static LispObjectPtr
lisp_AmbientLightColor(LispInterpreter* L, LispObjectPtr args,
...
static LispObjectPtr
lisp_Background(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
  auto h = L->NumVal(L->Car(args));
...
static LispObjectPtr
lisp_Color(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
  auto h = L->NumVal(L->Car(args));
...
static LispObjectPtr
lisp_FramesPerSecond(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                     void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_Height(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
            void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_LightColor(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
  auto h = L->NumVal(L->Car(args));
...
static LispObjectPtr
lisp_Message(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
             void* data)
{
  auto msg = L->Car(args);
...
static LispObjectPtr
lisp_StepMouseX(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                void* data)
{
...
static LispObjectPtr
lisp_StepMouseY(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                void* data)
{
  auto self = L->Car(args);
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_RotateX(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
             void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_RotateY(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
             void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_RotateZ(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
             void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_Scale(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_Tetrahedron(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                 void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_Translate(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
               void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
static LispObjectPtr
lisp_Width(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
  auto app = static_cast<ProcdrawApp*>(data);
...
void
RegisterProcdrawAppFunctions(ProcdrawApp* app, LispInterpreter* L)
{
