...
#include "procdraw/opengl/bitmap_text_renderer.h"
#include "procdraw/opengl/camera.h"
#include <GL/gl3w.h>
...
public:
  ...
  void Cube();
  void DoSwap();
  void DrawBlockCursorBackground(int cursorX, int cursorY, int cursorWidth,
                                 int cursorHeight);
  void DrawBlockCursorInversion(int cursorX, int cursorY, int cursorWidth,
                                int cursorHeight);
