...
void GlRenderer::Begin2D()
{
    ...
    glUniformMatrix4fv(projection2dLoc_, 1, GL_FALSE,
...
void GlRenderer::DrawBlockCursorInversion(int cursorX,
                                          int cursorY,
                                          int cursorWidth,
                                          int cursorHeight)
{
...
void GlRenderer::DrawText(int x,
                          int y,
...
void GlRenderer::UpdateUniformsForObject()
{
    ...
    glUniform4fv(lightDirectionLoc_, 1,
