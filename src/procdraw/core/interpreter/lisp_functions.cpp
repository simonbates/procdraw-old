#include "procdraw/core/interpreter/lisp_functions.h"
...
LispObjectPtr
lisp_Apply(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
...
LispObjectPtr
lisp_Assoc(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
...
LispObjectPtr
lisp_Clear(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
           void* data)
{
...
LispObjectPtr
lisp_Difference(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
                void* data)
{
...
LispObjectPtr
lisp_Functionp(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
               void* data)
{
...
LispObjectPtr
lisp_MakeDict(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
              void* data)
{
  return L->MakeDict();
}
...
LispObjectPtr
lisp_MapRange(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
              void* data)
{
...
LispObjectPtr
lisp_Product(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
             void* data)
{
  double product = 1;
...
LispObjectPtr
lisp_Putassoc(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
              void* data)
{
...
LispObjectPtr
lisp_Quotient(LispInterpreter* L, LispObjectPtr args, LispObjectPtr env,
              void* data)
{
