#include "procdraw/core/interpreter/prettyprinter.h"
...
PrettyPrinterToken
PrettyPrinterToken::Begin(int indentAmount)
{
...
PrettyPrinterToken
PrettyPrinterToken::End()
{
  return PrettyPrinterToken(PrettyPrinterTokenType::End);
}

PrettyPrinterToken
PrettyPrinterToken::String(const std::string& str)
{
  return PrettyPrinterToken(str);
}

PrettyPrinterToken
PrettyPrinterToken::Blank()
{
...
void
PrettyPrinter::Scan(LispInterpreter* L, LispObjectPtr obj)
{
  switch (L->TypeOf(obj)) {
...
void
PrettyPrinter::ScanListContents(LispInterpreter* L, LispObjectPtr obj)
{
  LispObjectPtr n = obj;
  while (!L->Null(n)) {
    Scan(L, L->Car(n));
...
void
PrettyPrinter::Emit(PrettyPrinterToken token)
{
  switch (token.Type) {
...
void
PrettyPrinter::Print(PrettyPrinterToken token)
{
  switch (token.Type) {
    case PrettyPrinterTokenType::String:
