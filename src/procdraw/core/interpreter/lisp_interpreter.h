...
public:
  ...
  LispObjectPtr Putassoc(LispObjectPtr key, LispObjectPtr val,
                         LispObjectPtr alist);
  LispObjectPtr Read(const std::string& str);
  LispObjectPtr Set(LispObjectPtr symbol, LispObjectPtr value,
                    LispObjectPtr env);
...
private:
  ...
  void InitSingletons();
  LispObjectPtr ApplyCFunction(LispObjectPtr cfun, LispObjectPtr args,
                               LispObjectPtr env);
