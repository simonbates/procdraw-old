...
namespace procdraw {
    ...
    int BitmapFontMetrics::MaxCharCode()
    {
        return glyphMetrics_.size() - 1;
    }

    void BitmapFontMetrics::SetGlyph(int charCode, const BitmapGlyphMetrics &glyphMetrics)
    {
        glyphMetrics_.at(charCode) = glyphMetrics;
    }

    BitmapGlyphMetrics& BitmapFontMetrics::GetGlyph(int charCode)
    {
