...
namespace procdraw {
    ...
    public:
        ...
        std::unordered_map<LispObjectPtr, LispObjectPtr, decltype(LispObjectHash)*, decltype(LispObjectEq)*> dictData_;
    };
    ...
    LispObjectPtr LispInterpreter::MakeDict()
    {
    ...
    LispObjectPtr LispInterpreter::Get(LispObjectPtr key, LispObjectPtr dict, LispObjectPtr notFound)
    {
    ...
    LispObjectPtr LispInterpreter::Get(LispObjectPtr key, LispObjectPtr dict)
    {
        return Get(key, dict, Nil);
    }

    LispObjectPtr LispInterpreter::Put(LispObjectPtr key, LispObjectPtr val, LispObjectPtr dict)
    {
        if (dict->Type == LispObjectType::Dictionary) {
    ...
    LispObjectPtr LispInterpreter::Keys(LispObjectPtr dict)
    {
    ...
    LispObjectPtr LispInterpreter::Clear(LispObjectPtr dict)
    {
        if (dict->Type == LispObjectType::Dictionary) {
